package androidhive.info.materialdesign.components;
...
public class MovingView extends SurfaceView {
    ...
    private Drawable backgroundDrawable = getResources().getDrawable(R.drawable.slide);
    private float speed = 0.35f;

    private int direction=1;

    private float firstImageY;
    private float followingImageY;

    private float firstImageX;
    private float followingImageX;
